# Contenido inicial ES/EN

Este archivo es copy de arranque. Debe pasar revisión humana antes del lanzamiento. Los corchetes indican datos pendientes; no deben llegar a producción.

## 1. Glosario

| Español | English | Regla |
|---|---|---|
| laboratorio de innovación GreenTech | GreenTech Innovation Lab | Descriptor principal |
| iniciativa familiar | family-led initiative | No usar family business |
| proyecto | project | Iniciativa con alcance definido |
| experimento | experiment | Trabajo temprano |
| etapa | stage | No maturity level |
| impacto potencial | potential impact | Hasta contar con evidencia |
| exploración reservada | private exploration | Teaser protegido |
| colaborar | collaborate | CTA institucional |

Mantener IA en español y AI en inglés. Mantener Cloud e IoT como términos técnicos aceptados. Evitar “revolucionario”, “disruptivo”, “salvar el planeta” y “cero impacto”.
...
Flagship, title: Monitoreo de costas con IA y drones

Flagship, body: Investigamos cómo combinar captura aérea, procesamiento en la nube y modelos de visión para apoyar la observación responsable de playas turísticas.

Flagship, disclaimer: Proyecto en desarrollo. El alcance operativo, los indicadores y el sitio piloto están sujetos a validación con actores locales y a los permisos aplicables.

Teaser:

Exploración reservada: Estamos investigando una experiencia digital vinculada al reconocimiento deportivo. Por encontrarse en proceso de protección de propiedad intelectual, compartiremos más información cuando sea oportuno.

Método:

De una pregunta a un piloto medible.

Research: Entendemos el problema, los datos, las restricciones y las personas involucradas.

Prototype: Construimos la prueba mínima que permita aprender.

Pilot: Probamos con un partner, en un contexto y con criterios acordados.

MVP: Consolidamos lo que demostró valor y decidimos cómo avanzar.
...
Flagship title: AI and drone coastal monitoring

Flagship body: We are exploring how aerial capture, cloud processing and vision models could support responsible observation of tourist beaches.

Flagship disclaimer: Project in development. Operational scope, indicators and pilot site remain subject to validation with local stakeholders and applicable permissions.

Teaser:

Private exploration: We are researching a digital experience related to sports recognition. Because the concept is undergoing intellectual-property protection, we will share more when appropriate.

Method:

From a question to a measurable pilot.

Research: We understand the problem, data, constraints and people involved.

Prototype: We build the smallest proof that can produce learning.

Pilot: We test with a partner, in context and against agreed criteria.

MVP: We consolidate what demonstrated value and decide how to move forward.
...
H1: Un laboratorio para aprender construyendo

Lead: No empezamos por una herramienta. Empezamos por una pregunta, las personas afectadas y la evidencia necesaria para tomar una mejor decisión.

Principios: Problemas reales. Etapas visibles. Datos responsables. Colaboración abierta. Aprendizaje documentado.

### EN

H1: A lab for learning by building

Lead: We do not start with a tool. We start with a question, the people affected and the evidence needed to make a better decision.

Principles: Real problems. Visible stages. Responsible data. Open collaboration. Documented learning.
...
Aviso tokenización: Contenido educativo y cultural. No constituye asesoramiento financiero, legal ni de inversión.
...
Tokenization notice: Educational and cultural content only. It is not financial, legal or investment advice.

## 7. Projects

### ES

H1: Proyectos y experimentos

Lead: Algunas ideas comienzan como preguntas. Otras avanzan hacia prototipos, pilotos o nuevas iniciativas. Mostramos la etapa real para que sea más fácil entender dónde colaborar.

### EN

H1: Projects and experiments

Lead: Some ideas begin as questions. Others move toward prototypes, pilots or new initiatives. We show the actual stage so it is easier to understand where collaboration can help.

## 8. Collaborate

### ES

H1: Construyamos la próxima prueba juntos

Lead: Buscamos relaciones concretas, con expectativas claras y una pregunta que podamos validar.

Opciones: Proponer un sitio piloto · Compartir datos · Investigar · Aportar Cloud o equipamiento · Facilitar un taller · Apoyar un proyecto.

### EN

H1: Let us build the next test together

Lead: We seek concrete relationships, clear expectations and a question we can validate.

Options: Propose a pilot site · Share data · Research · Contribute Cloud or equipment · Host a workshop · Support a project.
...
H1: Cuéntanos qué quieres explorar
...
Error: No pudimos enviar tu mensaje. Revisa tu conexión e inténtalo nuevamente, o escribe a hola@holamundoverde.com.

### EN

H1: Tell us what you want to explore
...
Error: We could not send your message. Check your connection and try again, or email hola@holamundoverde.com.

## 11. Footer

### ES

GreenTech Innovation Lab · Maldonado, Uruguay  
Exploramos ideas, construimos prototipos y aprendemos en colaboración.  
Privacidad · Contacto · Español · English

### EN

GreenTech Innovation Lab · Maldonado, Uruguay  
We explore ideas, build prototypes and learn through collaboration.  
Privacy · Contact · Español · English

## 12. Mensajes de etapa

| Estado | ES | EN |
|---|---|---|
| idea | Idea | Idea |
| research | Investigación | Research |
| prototype | Prototipo | Prototype |
| pilot | Piloto | Pilot |
| mvp | MVP | MVP |
